      ...
      <div className="home-container">
        <div className="home-content">
          ...
          <div className="home-subtext">
            ...
            <p>
              Book electricians, plumbers, carpenters, and other skilled workers
              in minutes.
            </p>
          </div>
          ...
          <div className="userStats">
            <h1>
              ...
              <span>Users</span> and{" "}
              <span className="userStats-number">1000+</span>
              <span>Workers</span>
            </h1>
          </div>
